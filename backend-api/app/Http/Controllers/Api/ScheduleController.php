...
class ScheduleController extends Controller
{
    ...
    public function makeScheduleApi(Request $req){
        try{
            ...
            if ($req->has('serviceTypeUmum')) {
                ...
                $newscheduledetail ->serviceType = 'servis umum';
            ...
            if ($req->has('serviceTypeBerkala')) {
                foreach($req->serviceTypeBerkala as $key => $value){
                    $newscheduledetail = new ScheduleDetail;
                    $newscheduledetail -> scheduleID = $idSchedule;
                    $newscheduledetail ->serviceType = 'servis berkala';
    ...
    public function ShowDataScheduleByUserID(Request $req){
        try{
            ...
            ->select('schedules.id','schedules.userID','schedules.workshopID','schedules.workshopName','schedules.workshopAddress',
